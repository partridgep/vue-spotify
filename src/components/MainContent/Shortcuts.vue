  ...
  <div>
    ...
    <div class="flex flex-wrap justify-between">
      <button
        ...
        :key="index"
        class="flex-grow flex flex-row items-center text-white text-left font-semibold tracking-wide w-32 h-20 bg-gradient-to-b from-light to-light rounded mr-5 mb-3 md:w-56 hover:from-gray-600 hover:to-gray-700 focus:outline-none"
        v-show="index < 4 || index >= 4 && index < 6 && show6 || index >= 6 && show8"
      ...
      >
        ...
        <button v-show="showPlayBtn && hoveredIdx === index" class="rounded-full ml-auto mr-3 bg-green flex shadow-2xl focus:outline-none">
